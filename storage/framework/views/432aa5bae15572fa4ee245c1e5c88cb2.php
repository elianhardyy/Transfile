                ...
                <div class="card shadow rounded-0 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-lg-6 bg-login d-flex align-items-center justify-content-center">
                            <img src="<?php echo e(asset('auth/images/error/login-img.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6">
                                ...
                                <form class="form-body">
                                    <div class="d-grid">
                                        <a class="btn btn-white radius-30" href="javascript:;"><span
                                                ...
                                                <img class="me-2" src="<?php echo e(asset('auth/images/icons/search.svg')); ?>"
                                                    width="16" alt="">
...
<!--end wrapper-->
<?php /**PATH E:\11nafi\HOST\Laravel-App\TransLife\resources\views/partials/authup.blade.php ENDPATH**/ ?>