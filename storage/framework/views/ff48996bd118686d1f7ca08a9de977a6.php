...
<header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <a href="/" class="logo d-flex align-items-center">
            <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="TransLife By Nafi'">
            <span>TransLife</span>
        </a>
...
<?php /**PATH E:\11nafi\HOST\Laravel-App\TransLife\resources\views/partials/navbar.blade.php ENDPATH**/ ?>